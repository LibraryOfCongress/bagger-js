...
export function hasher(state = {
    ...
    case ActionTypes.UPDATE_THROUGHPUT:
        ...
        return {...state, hashBytesPerSecond, hashThroughput: [now, bytesHashed] }
...
export function uploader(state = {
    ...
    case ActionTypes.CONFIG_STATUS:
        return {...state, configStatus: action.status};
    ...
    case ActionTypes.UPDATE_THROUGHPUT:
        ...
        return {...state, uploadBytesPerSecond, uploadThroughput: [now, bytesUploaded]}
    default:
        return state;
    }
}
